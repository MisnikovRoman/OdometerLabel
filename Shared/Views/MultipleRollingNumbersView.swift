...
//
//    private var basicSettings = OneRollingNumberView.Debug(isClipped: true, showBorder: false, from: 0, to: 1, isIncreasing: true, rounds: 1, duration: 1.0, animationToggle: false)
//    @Published var initialNumber = 0
//    @Published var finalNumber = 1
//
//    init() {
//        Publishers.Zip($initialNumber, $finalNumber)
//            .sink { [unowned self] in
//                self.basicSettings.from = $0
//                self.basicSettings.to = $1
//            }
